...
menu() {
    ...
    echo -e "# ${GREEN}作者${PLAIN}: Harveylhw                                       #"
    echo -e "# ${GREEN}博客${PLAIN}: https://bk.hyblog.ml                               #"
    echo -e "# ${GREEN}GitHub 项目${PLAIN}: https://github.com/Harveylhw                #"
    echo -e "# ${GREEN}Telegram 频道${PLAIN}: https://t.me/Harveylhw                    #"
    echo -e "# ${GREEN}Telegram 群组${PLAIN}: https://t.me/Harveylhw                    #"
    echo -e "# ${GREEN}YouTube 频道${PLAIN}: https://www.youtube.com/                   #"
    echo "#############################################################"
    echo ""
